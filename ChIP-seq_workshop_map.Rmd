...
<div class="blue">
```bash
#bwa index -p ~genomes/s.cerevisiae/sacCer3/bwa_indexes/sacCer3 -a is ~genomes/s.cerevisiae/sacCer3/sacCer3.fa
```
</div>
...
* Can you figure out what -F 260 does?

**HINT**
Use the [Explain SAM flags](https://broadinstitute.github.io/picard/explain-flags.html) resource.

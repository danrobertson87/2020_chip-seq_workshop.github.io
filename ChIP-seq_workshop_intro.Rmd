...
### Getting Started with Linux and RStudio

We are using the Linux command line to run most of the tools we use today. If you are new to Linux and wish to use the command line more often it is a good idea to learn about job control and how to track your processes. We can arrange a separate tutorial if required.
...
There are several options to login to our machines. You can use the **Terminal** app on a Mac or login via **X2G0** if you want a graphical interface. Alternatively you can use **RStudio** which is an environment built for R programming but also gives you access to the command line terminal, your file structure and several other graphical features. 
...
<h2><i class="fas fa-thumbtack"></i>You should now:</h2>
##
 * Be able to login to the bifx servers
 * Have a personal web directory at http://bifx-core.bio.ed.ac.uk/~yourUserName
 * Have created a project directory containing fastq files
</div>
<br>
...
There are several options to login to our machines. You can use the **Terminal** app on a Mac or equivalant on **Command Prompt** on Windows or login via **X2G0** if you want a graphical interface. 

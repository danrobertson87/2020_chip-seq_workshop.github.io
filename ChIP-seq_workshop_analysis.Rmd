...
First we want to create a new script for the analysis part of the exercise and we can save all new commands in here. The **touch** command creates a new file without opening it.

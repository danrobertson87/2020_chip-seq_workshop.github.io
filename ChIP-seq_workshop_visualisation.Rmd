...
1. Use the horizontal panel dividers to set the 3 panels to approximately equal height.
2. Select **Tracks->Fit Data To Window** To automatically set track heights to fill the view
3. Right click on the Refseq genes track and switch between display modes **Collapsed**, **Expanded** and **Squished**.
4. Use the right click menu on the bigwig track name to customise the display. Try the following:
  1. Rename the track
  2. Change the track colour
  3. Change the graph type
  4. Change the windowing function
  5. Set a minimum, mid and maximum Y-axis
5. Set the scale to **Autoscale**. This automatically sets the Y-axis to the height of the tallest peak in your view.
...
Next let's navigate the chromosome:
...
* Can you find any obvious peaks in the ChIP-seq samples?
...
* Assess raw sequence data and perform quality control
